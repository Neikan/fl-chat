...
mixin _$ApiMessageDeliveryConfirm {
  ApiActionDelivery get action => throw _privateConstructorUsedError;
...
class _$_ApiMessageDeliveryConfirm implements _ApiMessageDeliveryConfirm {
  const _$_ApiMessageDeliveryConfirm(
      {this.action = ApiActionDelivery.message_delivery_confirm,
  ...
  @override
  @JsonKey()
  final ApiActionDelivery action;
  @override
  @JsonKey(name: 'client_message_id')
