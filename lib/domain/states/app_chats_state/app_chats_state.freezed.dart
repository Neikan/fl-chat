...
class _$_AppChatsState implements _AppChatsState {
  const _$_AppChatsState({final List<ApiChat>? chats}) : _chats = chats;
  ...
  @override
  String toString() {
    return 'AppChatsState(chats: $chats)';
  }
...
abstract class _AppChatsState implements AppChatsState {
  const factory _AppChatsState({final List<ApiChat>? chats}) = _$_AppChatsState;
